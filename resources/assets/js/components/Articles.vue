<template>
    <div>
        ...
        <form @submit.prevent="addArticle">
            ...
            <button type="submit" class="btn btn-light btn-block mb-3">Save</button>
        </form>
        ...
        v-bind:key="article.id">
            ...
            <p>{{ article.body }}</p>
            <hr>
            <button @click="editArticle(article)" class="btn
            btn-warning mb-2">Edit</button>
            <button @click="deleteArticle(article.id)" class="btn
